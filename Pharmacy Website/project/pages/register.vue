    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        <NuxtLink to="/" class="inline-block">
          <h1 class="text-3xl font-bold text-green-600">MediPharm</h1>
        </NuxtLink>
      ...
      <div class="mt-6">
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-gradient-to-br from-green-50 to-blue-100 text-gray-500">Or register with</span>
          </div>
        </div>
...
useHead({
  title: 'Register - MediPharm',
  meta: [
    { name: 'description', content: 'Create your MediPharm account to access personalized healthcare services, track prescriptions, and manage your health records.' }
  ]
})
